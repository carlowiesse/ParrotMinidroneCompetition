...
uint32_T _flightControlSystemMachineNumber_;
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2696804901U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1119922893U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4279266478U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(625678592U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1125680086U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(164535126U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3712324114U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1261096U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(instanceChksum, "s3Rth7WWo4R195uyboBNLZE") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s3Rth7WWo4R195uyboBNLZE") == 0) {
...
void flightControlSystem_debug_initialize(struct SfDebugInstanceStruct*
  debugInstance)
{
  _flightControlSystemMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "flightControlSystem","sfun",0,2,0,0,0);
  sf_debug_set_machine_event_thresholds(debugInstance,
    _flightControlSystemMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds(debugInstance,
    _flightControlSystemMachineNumber_,0);
}
